...
{
    public class IchimokuCloudBtc3Strategy : IStrategy
    {
        ...
        public IchimokuCloudBtc3Strategy(IOptions<MacdStrategyOptions> options, IIndicatorFactory indicatorFactory)
        {
